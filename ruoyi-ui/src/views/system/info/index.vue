<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="序号" prop="excelId">
        <el-input
      ...
      <el-form-item label="类型" prop="signalType">
        <el-input
          v-model="queryParams.signalType"
          placeholder="请输入类型"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="序号" prop="excelId">
          <el-input v-model="form.excelId" placeholder="请输入序号" />
        </el-form-item>
        <el-form-item label="厂站ID" prop="stationId">
        ...
        <el-form-item label="类型" prop="signalType">
          <el-input v-model="form.signalType" placeholder="请输入类型" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除信号信息编号为"' + ids + '"的数据项？').then(function() {
        return delInfo(ids)
      }).then(() => {
        this.getList()
