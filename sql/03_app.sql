...
INSERT INTO app.sys_menu (menu_id,menu_name,parent_id,order_num,`path`,component,query,route_name,is_frame,is_cache,menu_type,visible,status,perms,icon,create_by,create_time,update_by,update_time,remark) VALUES (2,'系统监控',1,12,'monitor',NULL,'','',1,0,'M','0','0','','monitor','admin','2025-07-15 03:09:41','admin','2025-09-04 02:50:10','系统监控目录');
...
INSERT INTO app.sys_menu (menu_id,menu_name,parent_id,order_num,`path`,component,query,route_name,is_frame,is_cache,menu_type,visible,status,perms,icon,create_by,create_time,update_by,update_time,remark) VALUES (100,'用户管理',1,1,'user','system/user/index','','',1,0,'C','0','0','system:user:list','user','admin','2025-07-19 06:52:41','','2025-08-15 01:12:25','用户管理菜单');
INSERT INTO app.sys_menu (menu_id,menu_name,parent_id,order_num,`path`,component,query,route_name,is_frame,is_cache,menu_type,visible,status,perms,icon,create_by,create_time,update_by,update_time,remark) VALUES (101,'角色管理',1,2,'role','system/role/index','','',1,0,'C','0','0','system:role:list','peoples','admin','2025-07-18 10:37:41','','2025-07-29 06:50:52','角色管理菜单');
INSERT INTO app.sys_menu (menu_id,menu_name,parent_id,order_num,`path`,component,query,route_name,is_frame,is_cache,menu_type,visible,status,perms,icon,create_by,create_time,update_by,update_time,remark) VALUES (102,'菜单管理',1,3,'menu','system/menu/index','','',1,0,'C','0','0','system:menu:list','tree-table','admin','2025-08-15 03:02:41','','2025-08-25 05:15:50','菜单管理菜单');
INSERT INTO app.sys_menu (menu_id,menu_name,parent_id,order_num,`path`,component,query,route_name,is_frame,is_cache,menu_type,visible,status,perms,icon,create_by,create_time,update_by,update_time,remark) VALUES (103,'部门管理',1,4,'dept','system/dept/index','','',1,0,'C','0','0','system:dept:list','tree','admin','2025-08-27 15:21:41','','2025-09-02 14:46:21','部门管理菜单');
INSERT INTO app.sys_menu (menu_id,menu_name,parent_id,order_num,`path`,component,query,route_name,is_frame,is_cache,menu_type,visible,status,perms,icon,create_by,create_time,update_by,update_time,remark) VALUES (104,'岗位管理',1,5,'post','system/post/index','','',1,0,'C','0','0','system:post:list','post','admin','2025-07-31 09:14:41','','2025-08-25 14:54:59','岗位管理菜单');
INSERT INTO app.sys_menu (menu_id,menu_name,parent_id,order_num,`path`,component,query,route_name,is_frame,is_cache,menu_type,visible,status,perms,icon,create_by,create_time,update_by,update_time,remark) VALUES (105,'字典管理',1,6,'dict','system/dict/index','','',1,0,'C','0','0','system:dict:list','dict','admin','2025-07-11 09:13:41','','2025-08-13 12:39:14','字典管理菜单');
INSERT INTO app.sys_menu (menu_id,menu_name,parent_id,order_num,`path`,component,query,route_name,is_frame,is_cache,menu_type,visible,status,perms,icon,create_by,create_time,update_by,update_time,remark) VALUES (106,'参数设置',1,7,'config','system/config/index','','',1,0,'C','0','0','system:config:list','edit','admin','2025-07-20 17:17:41','','2025-08-30 20:51:48','参数设置菜单');
INSERT INTO app.sys_menu (menu_id,menu_name,parent_id,order_num,`path`,component,query,route_name,is_frame,is_cache,menu_type,visible,status,perms,icon,create_by,create_time,update_by,update_time,remark) VALUES (107,'通知公告',1,8,'notice','system/notice/index','','',1,0,'C','0','0','system:notice:list','message','admin','2025-09-04 02:35:41','','2025-09-05 10:54:31','通知公告菜单');
INSERT INTO app.sys_menu (menu_id,menu_name,parent_id,order_num,`path`,component,query,route_name,is_frame,is_cache,menu_type,visible,status,perms,icon,create_by,create_time,update_by,update_time,remark) VALUES (108,'日志管理',1,9,'log','','','',1,0,'M','0','0','','log','admin','2025-08-03 12:33:41','','2025-08-11 21:06:47','日志管理菜单');
INSERT INTO app.sys_menu (menu_id,menu_name,parent_id,order_num,`path`,component,query,route_name,is_frame,is_cache,menu_type,visible,status,perms,icon,create_by,create_time,update_by,update_time,remark) VALUES (109,'在线用户',2,1,'online','monitor/online/index','','',1,0,'C','0','0','monitor:online:list','online','admin','2025-09-03 15:37:41','','2025-09-05 03:49:36','在线用户菜单');
INSERT INTO app.sys_menu (menu_id,menu_name,parent_id,order_num,`path`,component,query,route_name,is_frame,is_cache,menu_type,visible,status,perms,icon,create_by,create_time,update_by,update_time,remark) VALUES (110,'定时任务',2,2,'job','monitor/job/index','','',1,0,'C','0','0','monitor:job:list','job','admin','2025-07-30 16:45:41','','2025-09-03 12:33:57','定时任务菜单');
...
INSERT INTO app.sys_menu (menu_id,menu_name,parent_id,order_num,`path`,component,query,route_name,is_frame,is_cache,menu_type,visible,status,perms,icon,create_by,create_time,update_by,update_time,remark) VALUES (2000,'信息点表管理',1,5,'info','system/info/index',NULL,'',1,0,'C','0','0','system:info:edit','online','admin','2025-08-23 21:08:41','admin','2025-09-06 09:40:32','信号信息菜单');
...
INSERT INTO app.sys_menu (menu_id,menu_name,parent_id,order_num,`path`,component,query,route_name,is_frame,is_cache,menu_type,visible,status,perms,icon,create_by,create_time,update_by,update_time,remark) VALUES (2065,'帮助中心',1,7,'helpcenter','system/helpcenter/index',NULL,'',1,0,'C','0','0',NULL,'user','admin','2025-08-01 00:30:41','','2025-08-17 09:12:09','');
INSERT INTO app.sys_menu (menu_id,menu_name,parent_id,order_num,`path`,component,query,route_name,is_frame,is_cache,menu_type,visible,status,perms,icon,create_by,create_time,update_by,update_time,remark) VALUES (2066,'限流管理',1,9,'confine','system/confine/index',NULL,'',1,0,'C','0','0','','example','admin','2025-07-15 22:10:41','admin','2025-09-04 03:09:03','');
INSERT INTO app.sys_menu (menu_id,menu_name,parent_id,order_num,`path`,component,query,route_name,is_frame,is_cache,menu_type,visible,status,perms,icon,create_by,create_time,update_by,update_time,remark) VALUES (2067,'应用成效展示',1,10,'results','system/results/index',NULL,'',1,0,'C','0','0',NULL,'server','admin','2025-08-09 12:56:41','','2025-09-02 19:56:58','');
INSERT INTO app.sys_menu (menu_id,menu_name,parent_id,order_num,`path`,component,query,route_name,is_frame,is_cache,menu_type,visible,status,perms,icon,create_by,create_time,update_by,update_time,remark) VALUES (2068,'意见反馈',1,1,'feedback','system/feedback/index',NULL,'',1,0,'C','0','0','system:feedback:list','build','admin','2025-08-09 07:23:41','admin','2025-09-04 10:14:25','意见反馈菜单');
...
INSERT INTO app.sys_menu (menu_id,menu_name,parent_id,order_num,`path`,component,query,route_name,is_frame,is_cache,menu_type,visible,status,perms,icon,create_by,create_time,update_by,update_time,remark) VALUES (2086,'频发错误统计',1,10,'mpresulterror','mpresult/error',NULL,'',1,0,'C','0','0',NULL,'#','admin','2025-07-13 04:53:41','','2025-09-04 03:41:40','');
INSERT INTO app.sys_menu (menu_id,menu_name,parent_id,order_num,`path`,component,query,route_name,is_frame,is_cache,menu_type,visible,status,perms,icon,create_by,create_time,update_by,update_time,remark) VALUES (2087,'监控信息人工修改',1,15,'mpresultedit','mpresult/customedit',NULL,'',1,0,'C','0','0',NULL,'#','admin','2025-07-14 07:07:41','','2025-07-23 12:19:10','');
INSERT INTO app.sys_menu (menu_id,menu_name,parent_id,order_num,`path`,component,query,route_name,is_frame,is_cache,menu_type,visible,status,perms,icon,create_by,create_time,update_by,update_time,remark) VALUES (2088,'旧版入口',1,1,'http://47.110.76.101:6203',NULL,NULL,'',0,0,'M','0','0',NULL,'#','admin','2025-08-23 13:53:41','','2025-09-06 03:59:17','');
